...
const MAP_PATH = "./mapas/";
const currentMap = "mapa_cascata_vila.png";
...
function createGrid() {
    ...
    gridElement.style.gridTemplateColumns = `repeat(${SIZE}, 80px)`;
    gridElement.style.gridTemplateRows = `repeat(${SIZE}, 80px)`;
    gridElement.style.width = `${SIZE * 80}px`;
    gridElement.style.height = `${SIZE * 80}px`;
